    ...
    while True:
        ...
        if await web3go.error_functions(web3go.login):
            ...
            if not web3go.web3_utils.balance_of_erc721(web3go.web3_utils.acct.address, '0xa4Aff9170C34c0e38Fed74409F5742617d9E80dc'):
                status, tx_hash = await web3go.error_functions(web3go.mint_nft_pass)
